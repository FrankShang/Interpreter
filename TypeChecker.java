...
public abstract class TypeChecker extends Parser
{
	...
	public static HashMap<String,HashMap<Integer, String>> paramFunNameNumNameMap = new HashMap<String,HashMap<Integer, String>>();
		//for each function name, records declared parameter name of i-th formal parameters, indexed by i
